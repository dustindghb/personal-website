...
export default function DStation() {
  const media = [
    {
      src: "https://github.com/dustindghb/dstation",
      caption: "Distributed Agent Communication System - GitHub Repository showcasing concurrent UDP server implementation in Go",
      type: "image" as const,
